...
class ApiSubscriberTest extends MauticMysqlTestCase
{
    ...
    {
        $customObject = $this->createCustomObjectWithAllFields(self::getContainer(), 'Product');
    ...
    public function testCreatingContactWithCustomItemsWithDefaultValue(): void
    {
        ...
        $customObject = $this->createCustomObjectWithAllFields(self::getContainer(), 'Product', $configureFieldCallback);
        $contact      = [
            'email'         => 'contact1@api.test',
            'customObjects' => [
                'data' => [
